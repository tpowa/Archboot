...
grep -v -E 'amd|atmel|ath[0-9]|brcm|i915|imx|intel|iwlwifi|libertas|mediatek|mrvl|mwl*|nvidia|radeon|rsi|rtl|ti-connect|/.zst' firmware.txt > error-firmware.txt
