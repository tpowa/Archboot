...
grub-mkrescue --compress="xz" --fonts="unicode" --locales="" --themes="" -o "${_IMAGENAME}.iso" -volid "Arch Linux ARCHBOOT ${_RELEASENAME}" -preparer "prepared by ${_BASENAME}" "${_X86_64}"/  &> "${_IMAGENAME}.log"
