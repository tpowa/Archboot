...
_MEM_LIMIT_BARE_MINIMUM=696900
_MEM_LIMIT_FREE_RAM=1000000
_MEM_LIMIT_FULL=2960000
_MEM_LIMIT_GRAPHIC=2400000
_MEM_LIMIT_ISO=5516000
_MEM_LIMIT_LATEST=2270000
_MEM_LIMIT_LOW_GRAPHIC=1500000
_MEM_LIMIT_PACKAGE_CACHE=3161000
_NO_LOG="/dev/null"
...
if [[ ! -e "${_TEMPLATE}" ]]; then
    ...
    echo "# created by Tobias Powalowski <tpowa@archlinux.org>"
