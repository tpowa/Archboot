...
dsp56k,dvb*,e100,edgeport,emi26,ene-ub6250,f2255usb*,go7007,hfi1*,INT*,intel/{avs,catpt,dsp*,ibt*,ice,ipu,irci*,ish,qat,vpu,vsc},imx,\
inside-secure,isci,isdbt*,ixp4xx,kaweth,keyspan*,lbtf*,lt8713sx*,lt9611uxc*,matrox,meson,microchip,moxa,\
mrvl/prestera,mts*,myri10ge*,nxp,ositech,phanfw*,powervr,qat*,qca,r128,r8a*,rcar_*,realtek,rockchip,rp2*,rtl_bt,rsi*,sb16,s2250*,\
s5p-*,sdca,sdd_*,slicoss,sms1*,sxg,tdmb*,ueagle-atm,usbdux*,tas25*,TAS*,TIAS*,tehuti,ti,ti_*,\
ti-keystone,tlg2300*,tsse_*,v4l*,vntw*,vxge,wsm_*,wfx,whiteheat*,yamaha}
        fi
    fi
}
