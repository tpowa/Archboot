...
_set_device_name_scheme() {
    ...
    _dialog --no-cancel --title " Device Name Scheme " --menu "Use PARTUUID on GPT disks. Use FSUUID on MBR/MSDOS disks." 12 70 6 ${_NAME_SCHEME_LEVELS} 2>"${_ANSWER}" || return 1
