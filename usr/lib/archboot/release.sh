...
_create_iso() {
    ...
    if ! [[ "${_ARCH}" == "riscv64" ]]; then
        ...
        #    ${_DLPROG} "https://archboot.com/src/grub/grub-2:2.06.r533.g78bc9a9b2-1-x86_64.pkg.tar.zst" -O "${_W_DIR}/var/cache/pacman/pkg"
        #    ${_DLPROG} "https://archboot.com/src/grub/grub-2:2.06.r533.g78bc9a9b2-1-x86_64.pkg.tar.zst.sig" -O "${_W_DIR}/var/cache/pacman/pkg"
        #fi
