...
_create_iso() {
    ...
    if ! [[ "${_ARCH}" == "riscv64" ]]; then
        ...
        #    ${_DLPROG} -o "${_W_DIR}/var/cache/pacman/pkg "https://archboot.com/src/grub/grub-2:2.06.r533.g78bc9a9b2-1-x86_64.pkg.tar.zst" "
        #    ${_DLPROG} -o "${_W_DIR}/var/cache/pacman/pkg "https://archboot.com/src/grub/grub-2:2.06.r533.g78bc9a9b2-1-x86_64.pkg.tar.zst.sig"
        #fi
