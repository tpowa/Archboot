...
_new_environment() {
    ...
    echo "          This will need some time ..."
    # add fix for mkinitcpio 33, remove when 34 is released
    cp "${_W_DIR}"/usr/share/archboot/patches/33-initcpio.functions.fixed "${_W_DIR}"/usr/lib/initcpio/functions
