...
_TRIGGER="archboot bcachefs-tools btrfs-progs coreutils cryptsetup device-mapper dosfstools e2fsprogs glibc linux linux-firmware lvm2 mdadm systemd thin-provisioning-tools openssh ttyd util-linux xfsprogs"
